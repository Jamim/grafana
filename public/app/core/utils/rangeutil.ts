...
var rangeOptions = [
  ...
  { from: 'now-5m',   to: 'now-1s',     display: 'Last 5 minutes',           section: 3 },
  { from: 'now-15m',  to: 'now-1s',     display: 'Last 15 minutes',          section: 3 },
  { from: 'now-30m',  to: 'now-1s',     display: 'Last 30 minutes',          section: 3 },
  { from: 'now-1h',   to: 'now-1s',     display: 'Last 1 hour',              section: 3 },
  { from: 'now-3h',   to: 'now-1s',     display: 'Last 3 hours',             section: 3 },
  { from: 'now-6h',   to: 'now-1s',     display: 'Last 6 hours',             section: 3 },
  { from: 'now-12h',  to: 'now-1s',     display: 'Last 12 hours',            section: 3 },
  { from: 'now-24h',  to: 'now-1s',     display: 'Last 24 hours',            section: 3 },

  { from: 'now-2d',   to: 'now-1s',     display: 'Last 2 days',              section: 0 },
  { from: 'now-7d',   to: 'now-1s',     display: 'Last 7 days',              section: 0 },
  { from: 'now-30d',  to: 'now-1s',     display: 'Last 30 days',             section: 0 },
  { from: 'now-90d',  to: 'now-1s',     display: 'Last 90 days',             section: 0 },
  { from: 'now-6M',   to: 'now-1s',     display: 'Last 6 months',            section: 0 },
  { from: 'now-1y',   to: 'now-1s',     display: 'Last 1 year',              section: 0 },
  { from: 'now-2y',   to: 'now-1s',     display: 'Last 2 years',             section: 0 },
  { from: 'now-5y',   to: 'now-1s',     display: 'Last 5 years',             section: 0 },
];
